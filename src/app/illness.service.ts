...
export class IllnessService {
  ...
  updateDonation(totalDonations, key){
    console.log(totalDonations +" "+key);
    var illnessEntryInFirebase = this.getIllnessById(key);
    illnessEntryInFirebase.update({donation: totalDonations});
  }
